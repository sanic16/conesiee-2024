...
const ComboPaymentForm: React.FC<IndividualPaymentFormProps> = ({
  ...
  const [formState, action] = useFormState(
    createComboPaymentAction.bind(null, { captcha }, { registrationPackage }),
    {
      errors: {},
    }
  );
  return (
    <form action={action} className={classes.form}>
      ...
      <FormInput
        ...
        icon={<FaUser />}
        error={
          formState.errors.namePerson1 &&
          formState.errors.namePerson1.join(", ").toString()
        }
      />
      <FormInput
        type="text"
      ...
      <FormInput
        ...
        icon={<FaIdCard />}
        error={
          formState.errors.dpiPerson1 &&
          formState.errors.dpiPerson1.join(", ").toString()
        }
      />
      <FormInput
        type="text"
      ...
      <FormInput
        ...
        icon={<FaUser />}
        error={
          formState.errors.namePerson2 &&
          formState.errors.namePerson2.join(", ").toString()
        }
      />
      <FormInput
        type="text"
      ...
      <FormInput
        ...
        icon={<FaIdCard />}
        error={
          formState.errors.dpiPerson2 &&
          formState.errors.dpiPerson2.join(", ").toString()
        }
      />
      <FormInput
        type="text"
      ...
      <FormInput
        ...
        icon={<FaUser />}
        error={
          formState.errors.namePerson3 &&
          formState.errors.namePerson3.join(", ").toString()
        }
      />
      <FormInput
        type="text"
      ...
      <FormInput
        ...
        icon={<FaIdCard />}
        error={
          formState.errors.dpiPerson3 &&
          formState.errors.dpiPerson3.join(", ").toString()
        }
      />
      <FormInput
        type="text"
